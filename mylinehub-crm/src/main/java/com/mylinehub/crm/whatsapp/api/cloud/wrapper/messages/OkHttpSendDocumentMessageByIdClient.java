...
@Service
@AllArgsConstructor
public class OkHttpSendDocumentMessageByIdClient {

	private final SendMessageToWhatsApp sendMessageToWhatsApp;
	
	public JSONObject sendMessage(String caption,String fileName,String messagingProduct,String recipientPhoneNumber,String previousMessageId,String documentId,String version,String phoneNumberID, String token) throws Exception
	{
		...
		try {
			...
			documentObject.put(SEND_MESSAGE_KEYS.id.name(), documentId);
			if(caption!=null)
