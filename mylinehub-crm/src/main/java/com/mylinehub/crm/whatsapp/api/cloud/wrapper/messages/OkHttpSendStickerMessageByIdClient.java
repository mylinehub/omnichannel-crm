...
@Service
@AllArgsConstructor
public class OkHttpSendStickerMessageByIdClient {

	private final SendMessageToWhatsApp sendMessageToWhatsApp;
	
	public JSONObject sendMessage(String caption,String fileName, String messagingProduct,String recipientPhoneNumber,String previousMessageId,String stickerId,String version,String phoneNumberID, String token) throws Exception
	{
		...
		try {
			...
			stickerObject.put(SEND_MESSAGE_KEYS.id.name(), stickerId);
			if(caption!=null)
