...
@Service
@AllArgsConstructor
public class OkHttpSendImageMessageByUrlClient {
	
	private final SendMessageToWhatsApp sendMessageToWhatsApp;
	
	public JSONObject sendMessage(String caption,String fileName, String messagingProduct,String recipientPhoneNumber,String previousMessageId,String imageUrl,String version,String phoneNumberID, String token) throws Exception
	{
		...
		try {
			...
			imageObject.put(SEND_MESSAGE_KEYS.link.name(), imageUrl);
			if(caption!=null)
