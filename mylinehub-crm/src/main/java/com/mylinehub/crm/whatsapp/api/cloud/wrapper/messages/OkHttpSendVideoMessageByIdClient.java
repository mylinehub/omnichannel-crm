...
@Service
@AllArgsConstructor
public class OkHttpSendVideoMessageByIdClient {

	private final SendMessageToWhatsApp sendMessageToWhatsApp;
	
	public JSONObject sendMessage(String caption,String fileName, String messagingProduct,String recipientPhoneNumber,String previousMessageId, String videoId,String version,String phoneNumberID, String token) throws Exception
	{
		...
		try {
			...
			videoObject.put(SEND_MESSAGE_KEYS.id.name(), videoId);
			if(caption!=null)
