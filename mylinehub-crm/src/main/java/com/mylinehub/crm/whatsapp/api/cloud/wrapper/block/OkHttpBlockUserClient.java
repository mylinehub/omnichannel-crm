...
@Service
@AllArgsConstructor
public class OkHttpBlockUserClient {

	private final SendMessageToWhatsApp sendMessageToWhatsApp;
	
	public JSONObject blockUser(String version,String mediaUrl, String token) throws Exception
	{
		...
		try {
			...
			try (Response response = sendMessageToWhatsApp.sendBlockUserMessage(body, version, mediaUrl, token)) {
