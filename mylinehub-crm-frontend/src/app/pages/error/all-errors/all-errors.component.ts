...
@Component({
  selector: 'ngx-all-errors',
  templateUrl: './all-errors.component.html',
  styleUrls: ['./all-errors.component.scss']
})
export class AllErrorsComponent implements OnInit, OnDestroy {
  
  tableHeading = 'All Errors';
  ...
  setTable()
  {
    this.errorService.getAllErrorsByOrganization(this.organization)
  ...
  this.exportAsConfig.type = this.downloadAs;
    this.exportAsService
      .save(this.exportAsConfig, 'Errors')
      .subscribe(() => {
        // save started
      });
