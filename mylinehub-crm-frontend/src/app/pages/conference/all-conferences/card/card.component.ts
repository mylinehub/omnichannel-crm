 ...
 ngOnInit(): void {
   // console.log(JSON.stringify(this.currentRecord));
    ...
    if(this.title == 'Enable/Disable')
    {
      ...
      if(!this.currentRecord.isconferenceactive)
      {
  ...
  async buttonClicked()
  {
    ...
    if(this.title == 'Enable/Disable')
    {
      if(this.currentRecord.isconferenceactive)
      {
        ...
        this.conferenceService.disableConferenceOnExtensionAndOrganization( {extension: this.currentRecord.confextension,organization: this.organization})
        ...
        .subscribe({
          next: result => {
            if(String(result) == 'true')
            {
              ...
              this.on = false;
              this.show = 'OFF';
              this.currentRecord.isconferenceactive = false;
      ...
      else
      {
        ...
        this.conferenceService.enableConferenceOnExtensionAndOrganization( {extension: this.currentRecord.confextension,organization: this.organization})
        .pipe(takeUntil(this.destroy$))
        .subscribe({
          next: result => {
            if(String(result) == 'true')
            {
             // console.log("Result is true, setting values to show on icon");
              this.on = true;
              this.show = 'ON';
              this.currentRecord.isconferenceactive = true;
              this.parent.emit('Enable/Disable');
            }
            else{
              //  console.log("Result is not true");
