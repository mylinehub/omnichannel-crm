...
import { NSecDialogComponent } from './n-sec-dialog/n-sec-dialog.component';
...
export class ScheduleCardComponent implements OnInit, OnDestroy, OnChanges{
  ...
  async buttonClicked()
  {
   // console.log("actionButtonClicked");
      ...
      if(this.title == 'Remove Job')
      {
        ...
        this.campaignService.removeStartScheduledCampgin(this.scheduleType,this.currentRecord.id,this.organization)
  ...
  /*showToast(status: NbComponentStatus, message:string) {
    ...
    showDialoge(header: string,icon: string,status: string, message:string) {
      ...
      showNSecondsDialoge() {
        ...
        this.dialogService.open(NSecDialogComponent, {
          context: {
      ...
      this.dialogService.open(FixedDateDialogComponent, {
        context: {
          currentRecord: this.currentRecord,
          organization: this.organization,
          isAlreadyScheduled: this.isAlreadyScheduled,
    ...
    showCronDialoge() {
          ...
          this.dialogService.open(CronDialogComponent, {
            context: {
              currentRecord: this.currentRecord,
              organization: this.organization,
              isAlreadyScheduled: this.isAlreadyScheduled,
