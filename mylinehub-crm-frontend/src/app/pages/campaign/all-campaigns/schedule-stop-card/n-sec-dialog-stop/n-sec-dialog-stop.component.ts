...
@Component({
  selector: 'ngx-n-sec-dialog-stop',
  templateUrl: './n-sec-dialog-stop.component.html',
  styleUrls: ['./n-sec-dialog-stop.component.scss']
})
export class NSecDialogStopComponent  implements OnInit, OnDestroy {
  ...
  constructor(protected ref: NbDialogRef<NSecDialogStopComponent>,
