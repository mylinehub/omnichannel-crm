...
@Component({
  selector: 'ngx-n-sec-customer-dialog',
  templateUrl: './n-sec-customer-dialog.component.html',
  styleUrls: ['./n-sec-customer-dialog.component.scss']
})
export class NSecCustomerDialogComponent implements OnInit, OnDestroy {
  ...
  constructor(protected ref: NbDialogRef<NSecCustomerDialogComponent>,
  ...
  submit(nSeconds) {
    ...
    this.customerService.scheduleAfterNSecCall(data)
